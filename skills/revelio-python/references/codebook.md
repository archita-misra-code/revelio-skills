...
This is the built-in variable reference for the major Revelio WRDS tables used by this skill. Revelio updates monthly; for a live exhaustive schema dump, run `scripts/dump_wrds_codebook.py` against WRDS.
